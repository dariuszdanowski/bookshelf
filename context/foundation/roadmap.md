...
- **S-50: użytkownik może ręcznie rozwiązać przez AI (Claude web_search, BYOK) detekcję bez kandydatów po wyczerpaniu strukturalnej kaskady (GB/OL/BN + word-level fallback)** — Zarchiwizowano 2026-07-13 → `context/archive/2026-07-13-ai-book-resolution-fallback/`. Lesson: —.
