...
- [ ] 2.1 `npm run lint` i `astro check` przechodzą
- [ ] 2.2 Nowe testy jednostkowe `schema.ts`/`budgetPolicy.ts` zielone

### Faza 3: API endpoint + atrybucja kosztu w `/account`

#### Automatyczne

- [ ] 3.1 `npm run lint`, `astro check`, `npm run build` przechodzą
- [ ] 3.2 Cała istniejąca suita Vitest nadal zielona
