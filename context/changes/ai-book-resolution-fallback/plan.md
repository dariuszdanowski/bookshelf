...
- [x] 4.1 `npm run lint`, `astro check` przechodzą — 67261ad
- [x] 4.2 Istniejące testy `DetectionReview`/`CostPanel` nadal zielone — 67261ad

### Faza 5: Testy

#### Automatyczne

- [x] 5.1 `npm run test:unit` — nowe + cała suita zielone — d5c06b0
- [x] 5.2 `npm run test:e2e` — nowy spec zielony, brak nowych flaków — d5c06b0
- [x] 5.3 `npm run lint && astro check && npm run build` czysto — d5c06b0
