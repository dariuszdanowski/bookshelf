      ...
      >
        <form onSubmit={onEditSubmit} className="grid gap-2 sm:grid-cols-[2fr_2fr_auto_auto]">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-3 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50"
          >
